...
class ExternalNode(gpi.NodeAPI):
    ...
    def initUI(self):
        # Widgets
        self.addWidget('PushButton', 'AutoAdd', button_title='OFF', toggle=True)
        self.addWidget('PushButton', 'Add Now', button_title='ADD', toggle=False)
        self.addWidget('Slider', 'Glue Dimension',min=-1,max=0,val=-1)
        self.addWidget('SpinBox', 'Glue Dim Size',min=0,max=0,val=0)
        self.addWidget('PushButton', 'Clear Output', button_title='RESET OUTPUT', toggle=True)
